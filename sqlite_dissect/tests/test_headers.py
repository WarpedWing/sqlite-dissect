...
def test_db_header_init(permuted_database):
    if permuted_database["expected_result"] == VALUE_ERROR:
        ...
        assert db_header.first_freelist_trunk_page_number == unpack(b">I", permuted_database["byte_array"][32:36])[0]
        ...
        assert db_header.largest_root_b_tree_page_number == unpack(b">I", permuted_database["byte_array"][52:56])[0]
...
def test_wal_index_header_init(wal_index_header_byte_array, expected_value):
    if expected_value == VALUE_ERROR:
        ...
        assert (
            ...
            == wal_index_header_byte_array[lock_reserved_start_offset:lock_reserved_end_offset]
        )
    ...
    if expected_value == VALUE_ERROR:
        ...
        for index in range(WAL_INDEX_READER_MARK_SIZE):
            ...
            assert (
                ...
                == unpack(b"<I", wal_index_checkpoint_info_byte_array[start_offset:end_offset])[0]
            )
